...
/**
 * Custom warm dark syntax theme matching the AOS design system.
 */
    ...
    <ReactMarkdown
      ...
      components={{
        ...
        code({ className, children, ...props }) {
          ...
          return (
            <code
              className="font-mono text-[12px] bg-bg-tertiary text-accent px-1.5 py-0.5 rounded-[4px] border border-border"
              {...props}
            >
              {children}
            </code>
        ...
        p({ children }) {
          return (
            <p className="text-[13px] text-text-secondary leading-[1.6] mb-2 last:mb-0">
              {children}
            </p>
          );
        },
        ...
        blockquote({ children }) {
          return (
            <blockquote className="border-l-2 border-accent/30 pl-3 my-2 text-text-tertiary italic">
              {children}
            </blockquote>
          );
        },
        ...
        th({ children }) {
          return (
            <th className="text-left text-[10px] font-[590] uppercase tracking-[0.04em] text-text-quaternary px-3 py-1.5 border-b border-border-tertiary">
              {children}
            </th>
          );
        },
        td({ children }) {
          return (
            <td className="text-[12px] text-text-secondary px-3 py-1.5 align-top">
              {children}
            </td>
          );
        },

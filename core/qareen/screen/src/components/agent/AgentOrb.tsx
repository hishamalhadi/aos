/**
 * AgentOrb — ElevenLabs Orb component adapted for AOS.
 *
 * Source: https://ui.elevenlabs.io/r/orb.json (MIT)
 * Three.js + GLSL shaders, audio-reactive, agent-state aware.
 *
 * Warm accent colors from DESIGN.md instead of ElevenLabs blue defaults.
 */
...
function Scene({
  ...
  useEffect(() => {
    const apply = () => {
      ...
      // AOS is always dark-first, but respect the theme toggle
